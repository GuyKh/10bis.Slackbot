...
export module SlackModule {
    export class SlackAttachment {
        ...
        constructor (fallback: string, title: string, color: string, titleLink: string, text: string, thumbUrl: string, ts: Number) {
    ...
    export class SlackResponse implements Commons.TenBisResponse {
        ...
        constructor (responseType: string, text: string, attachments: SlackAttachment[]) {
  ...
  export class SlackMessage {
    ...
    text: string;
      ...
      constructor(token: string, teamId: string, teamDomain: string,
         channelId: string, channelName: string, userId: string,
         userName: string, command: string, text: string) {
      this.token = token;
      this.team_id = teamId;
