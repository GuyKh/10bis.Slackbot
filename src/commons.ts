...
export module Commons {
  export class Restaurant {
    ...
    constructor(restaurantBuilder: RestaurantBuilder) {
      ...
      this._distanceFromUserInMeters =
        restaurantBuilder.DistanceFromUserInMeters;
      ...
      this._happyHourDiscountPercent =
        restaurantBuilder.HappyHourDiscountPercent;
      this._deliveryChargeValueType = restaurantBuilder.DeliveryChargeValueType;
      this._happyHourDiscountValidityString =
        restaurantBuilder.HappyHourDiscountValidityString;
      ...
      this._arrivalEstimatedDeliveryTime =
        restaurantBuilder.ArrivalEstimatedDeliveryTime;
      this._showEstimatedDeliveryTimes =
        restaurantBuilder.ShowEstimatedDeliveryTimes;
      ...
      this._happyHourResRulesDescription =
        restaurantBuilder.HappyHourResRulesDescription;
      this._phoneOrdersOnlyOnPortals =
        restaurantBuilder.PhoneOrdersOnlyOnPortals;
